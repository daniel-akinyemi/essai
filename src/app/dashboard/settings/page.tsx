    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 flex items-center justify-center">
          ...
          {/* Sign Out Confirmation Dialog - Moved outside to prevent z-index issues */}
          {showSignOutConfirm && (
            <div className="fixed inset-0 z-[9999] bg-black/50 flex items-center justify-center p-4" onClick={() => setShowSignOutConfirm(false)}>
              <div className="bg-white rounded-xl p-6 w-full max-w-md mx-auto shadow-2xl" onClick={e => e.stopPropagation()}>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Sign Out</h3>
